                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                Item {
                                    ...
                                    Image {
                                        id: profilePicture
                                        source: Functions.findHiResImage(display.profile_image_url_https)
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                text: qsTr("Joined in %1").arg(Functions.getValidDate(display.created_at).toLocaleDateString(Qt.locale(), "MMMM yyyy"))
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.primaryColor
                                wrapMode: Text.Wrap
                            }
