 ...
 * Adopted 2017 to the Qt 5.6 JS runtime by Sebastian J. Wolf
 *
...
var idna = {
  toAscii: function toAscii(domain) {
    if (domain.indexOf('xn--') === 0 && !domain.match(validAsciiDomain)) {
    ...
    try {
      for (var _stupidIndex = 0; _stupidIndex < labels.length; _stupidIndex++) {
          var label = labels[_stupidIndex];
